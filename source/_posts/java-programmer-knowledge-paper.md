...
[Safe Kernel Extensions Without Run-Time Checking](https://www.utdallas.edu/~hamlen/Papers/necula96safe.pdf)

[Time, Clocks, and the Ordering of Events in a Distributed System](https://lamport.azurewebsites.net/pubs/time-clocks.pdf)

[Implementing Remote Procedure Calls](http://bitsavers.org/pdf/xerox/parc/techReports/CSL-83-7_Implementing_Remote_Procedure_Calls.pdf)
...
[A Logic of Authentication](https://www.hpl.hp.com/techreports/Compaq-DEC/SRC-RR-39.pdf)
...
[an exercise in distributed computing](http://web.cs.wpi.edu/~cs4513/d07/Papers/Birrell,%20Levin,%20et.%20al.,%20Grapevine.pdf)

[Scale and performance in a distributed file system](https://www.cs.cmu.edu/~satya/docdir/howard-tocs-afs-1988.pdf)

[Disco : Running commodity operating system on scalable multiprocessor](http://pages.cs.wisc.edu/~remzi/Classes/838/Spring2013/Papers/bugnion97disco.pdf)

[Machine-independent virtual memory management for paged uniprocessor and multiprocessor architectures](http://www.eecg.toronto.edu/~yuan/teaching/gradOS/papers/mach-vm.pdf)



[ACM SIGOPS名人堂（第五期）](https://mp.weixin.qq.com/s/E6PYyQazvajmLy93Eo4JSg)

[The Multics Virtual Memory: Concepts and Design](https://courses.cs.washington.edu/courses/cse551/09au/papers/CSE550.Multics.pdf)
...
[Experience with processes and monitors in Mesa](https://people.eecs.berkeley.edu/~brewer/cs262/Mesa.pdf)

[VAXclusters: A Closely-Coupled Distributed System](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.74.727&rep=rep1&type=pdf)
...
[Crash Recovery in a Distributed Data Storage System](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/acrobat-21.pdf)

[The Recovery Manager of the System R Database Manager](https://courses.cs.washington.edu/courses/cse550/09au/papers/CSE550.GrayTM.pdf)
...
[A New Primary Copy Method to Support Highly-Available Distributed Systems](http://pmg.csail.mit.edu/papers/vr.pdf)

[The Part Time Parliament](https://lamport.azurewebsites.net/pubs/lamport-paxos.pdf)

[Memory Coherence in Shared Virtual Memory Systems](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.80.5091&rep=rep1&type=pdf)
...
[Tenex, A Paged Time Sharing System for the PDP-10](http://www.eecg.toronto.edu/~yuan/teaching/gradOS/papers/tenex.pdf)

[Distributed Snapshots: Determining Global States of a Distributed System](https://lamport.azurewebsites.net/pubs/chandy.pdf)

[A NonStop Kernel](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.626.6107&rep=rep1&type=pdf)

[Exploiting Virtual Synchrony in Distributed Systems](https://www.cs.cornell.edu/home/rvr/sys/p123-birman.pdf)
...
[A fast file system for UNIX](https://people.eecs.berkeley.edu/~brewer/cs262/FFS.pdf)

[Disconnected operation in the Coda File System](https://www.cs.cmu.edu/~satya/docdir/kistler-tocs-coda-1992.pdf)

[Transactional memory: architectural support for lock-free data structures](https://www.scss.tcd.ie/Jeremy.Jones/CS4021/herlihy93transactional.pdf)

[Efficient software-based fault isolation](https://courses.cs.washington.edu/courses/cse551/19wi/readings/sfi-sosp93.pdf)



[ACM SIGOPS名人堂（第十二期）](https://mp.weixin.qq.com/s/xRmAclbaB4iIfpkcyLKNSg)

[ReVirt: Enabling Intrusion Analysis through Virtual-Machine Logging and Replay](https://web.eecs.umich.edu/~pmchen/papers/dunlap02.pdf)
...
[On micro-kernel construction](http://www.cs.fsu.edu/~awang/courses/cop5611_s2004/microkernel.pdf)
